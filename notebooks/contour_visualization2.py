...
def overlay_images(base_color, overlap_color, alpha=0.5):
    ...
    base_color[overlap_color == 0] = 255
    return base_color

# New function to overlay two base image colors
def overlay_images_for_2_color(base_color1, base_color2, alpha=0.5):
    combined_color = base_color1 * alpha + base_color2 * (1 - alpha)
...
def overlap_contour(base_image, overlap_image, cmin=-100, cmax=100, outputpath=False, colormap=plt.cm.coolwarm, 
                    base_image2=None, cmin2=-100, cmax2=100, colormap2=plt.cm.viridis):
    # Load your data
